...
export default function ContentShowcaseSection({ id }: { id?: string }) {
  ...
  return (
    <section
      id={id}
      className="relative box-border flex w-full flex-col items-center gap-[40px] bg-[#1d2241] px-[20px] py-[40px] sm:px-[40px] sm:py-[50px] md:px-[60px] md:py-[60px] lg:flex-row lg:gap-[80px] lg:px-[80px] lg:py-[80px] overflow-hidden"
